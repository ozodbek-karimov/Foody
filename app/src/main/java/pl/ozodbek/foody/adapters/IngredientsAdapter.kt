package pl.ozodbek.foody.adapters
...
import pl.ozodbek.foody.databinding.IngredientsRowLayoutBinding
import pl.ozodbek.foody.models.ExtendedIngredient
import pl.ozodbek.foody.util.Constants.Companion.BASE_IMAGE_URL
import pl.ozodbek.foody.util.RecipesDiffUtil
import java.util.*
...
class IngredientsAdapter : RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.ingredientConsistensy.text = ingredientsList[position].consistency
